...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
    ...
    public JPrincipalApp(JRootApp appview, AppUser appuser) {
        System.out.println("In JPrincipalApp");
        m_appview = appview; 
        m_appuser = appuser;
    ...
    @Override
    public void setLinkTitle(String key) {
        this.linkTitle = key;
    }
    ...
    public class ScriptGroup {
        ...
        public void addUtilitiesAction(JPrincipalApp.ScriptGroup grp) {
            System.out.println("In utilities action in script group");
            LinkParser link = new LinkParser(grp);
            link.createSideMenu(m_dlSystem);
        }
    ...
    public void showTask(String sTaskClass) {
        ...
        if (m_appuser.hasPermission(sTaskClass)) {            
            ...
            if (m_jLastView == null 
                ...
                if(sTaskClass.equals("com.openbravo.pos.links.LinkJPanel")){
                    m_jLastView = null;
                }else{
