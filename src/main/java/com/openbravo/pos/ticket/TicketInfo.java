...
// Added JDL 28.05.13 for loyalty card functions
    ...
    /*
    Building the EAN function to generate the number underneath the barcode
    */
    public String printEAN () { 
        if (m_iTicketId> 0) { 
        // the layout of the barcode 
            Long _ean = new Long ("777000000000"); 
            String _sid = "" + m_iTicketId; 
            Long _id = new Long (_sid); 
            _ean = _ean + _id; 
            
            // calculation of the ean digit 13  
            Integer _char1 = new Integer (_ean.toString (). substring (0,1)); 
            Integer _char2 = new Integer (_ean.toString (). substring (1,2));
            Integer _char3 = new Integer (_ean.toString (). substring (2,3)); 
            Integer _char4 = new Integer (_ean.toString (). substring (3,4)); 
            Integer _char5 = new Integer (_ean.toString (). substring (4,5)); 
            Integer _char6 = new Integer (_ean.toString (). substring (5,6)); 
            Integer _char7 = new Integer (_ean.toString (). substring (6,7)); 
            Integer _char8 = new Integer (_ean.toString (). substring (7,8)); 
            Integer _char9 = new Integer (_ean.toString (). substring (8,9)); 
            Integer _char10 = new Integer (_ean.toString ().substring (9,10)); 
            Integer _char11 = new Integer (_ean.toString ().substring (10,11));
            Integer _char12 = new Integer (_ean.toString ().substring (11,12)); 

            Integer _resultat = new Integer ("0"); 
            _resultat = _resultat + _char1; 
            _resultat = _resultat + (_char2 * 3); 
            _resultat  = _resultat + _char3; 
            _resultat  = _resultat + (_char4 * 3); 
            _resultat  = _resultat + _char5; 
            _resultat  = _resultat + (_char6 * 3); 
            _resultat  = _resultat + _char7; 
            _resultat  = _resultat + (_char8 * 3); 
            _resultat  = _resultat + _char9; 
            _resultat  = _resultat + (_char10 * 3); 
            _resultat  = _resultat + _char11; 
            _resultat  = _resultat + (_char12 * 3); 

            System.out.println (_resultat); 

            Integer _res = (_resultat / 10);

            System.out.println (_res); 

            Integer _reste = (_resultat% 10); 

            System.out.println (_reste); 
            ...
            String _key = _res.toString (); 
            System.out.println ("EAN" + _ean.toString () + _key.substring (0,1)); 
            return _ean.toString () + _key.substring (0,1); 
