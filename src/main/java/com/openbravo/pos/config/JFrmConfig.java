...
public class JFrmConfig extends javax.swing.JFrame {
    ...
    public JFrmConfig(AppProperties props) {
                System.out.println("In constructor config");
        ...
        setTitle(AppLocal.APP_NAME_M + " - " + AppLocal.APP_VERSION + " - " + AppLocal.getIntString("Menu.Configuration"));
    ...
    private class MyFrameListener extends WindowAdapter{     
        ...
        public void windowClosing(WindowEvent evt) {
            if (config.deactivate()) {
                                System.out.println("In windowclosing config");
    ...
    public static void main(final String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                        System.out.println("In run config");
